...
public class CreatureFactory {
    public static Creature createCreature(Creatures creature) {
        return CreatureFactory.createCreature(creature, CreatureFactory.getDefaultStats(creature));
    }

    public static Stats createStats(Integer strength, Integer defence, Integer charisma, Integer hitPoints,
                                    Integer goldValue, Integer expValue) {
        return new Stats(strength, defence, charisma, hitPoints, goldValue, expValue);
    }

    public static Creature createCreature(Creatures creature, Stats stats) {
    ...
    private static Stats getDefaultStats(Creatures creature) {
        return switch (creature) {
